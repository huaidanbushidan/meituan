...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public static String yhm = "欢迎入驻盗版美团";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //tv1 = (TextView)navHeaderView.findViewById(R.id.userName);
        ...
        Button XinYongHu = (Button) findViewById(R.id.zhuce) ;
        XinYongHu.setOnClickListener(new OnClickListener() {
            @Override
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                signer = null;
                flag = 0;
                String memailview = mEmailView.getText().toString();
                String password1 = mPasswordView.getText().toString();
                SQLiteDatabase db = dbHelper.getWritableDatabase();
                if(memailview.equals("")){Toast.makeText(LoginActivity.this,"账号不能为空",Toast.LENGTH_SHORT).show();}
                else {
                    if(password1.equals("")){Toast.makeText(LoginActivity.this,"密码不能为空",Toast.LENGTH_SHORT).show();}
                    else {
                        String mima ;
                ...
                if (flag == 0)Toast.makeText(LoginActivity.this,"账号或密码错误",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
